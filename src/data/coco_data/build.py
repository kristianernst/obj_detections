...
from data.common import (AspectRatioGroupedDataset, DatasetFromList,
                         MapDataset, ToIterableDataset, seed_all_rng)
from data.sampler import InferenceSampler, TrainingSampler
from models.head.structures import BoxMode
from util.detection_util import check_metadata_consistency
...
def get_detection_dataset_dicts(
  ...
  if proposal_files is not None:
    ...
    dataset_dicts = [
      load_proposals_into_dataset(dataset_i_dicts, proposal_file) for dataset_i_dicts, proposal_file in zip(dataset_dicts, proposal_files)
    ]
