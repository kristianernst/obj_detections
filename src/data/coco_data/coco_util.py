...
from config.config import PathManager
from data.catalog import DatasetCatalog, MetadataCatalog
from models.head.structures import Boxes, BoxMode, PolygonMasks, RotatedBoxes
...
"""
  ...
  if total_num_valid_anns < total_num_anns:
    logger.warning(
      f"{json_file} contains {total_num_anns} annotations, but only " f"{total_num_valid_anns} of them match to images in the file."
    )
...
if __name__ == "__main__":
  ...
  print(MetadataCatalog.get("coco_2017_train"))

  register_coco_instances("coco_2017_val", {}, VAL_2017_JSON, VAL_2017_IMAGES)
  print(DatasetCatalog.get("coco_2017_val"))
