...
from config.config import CfgNode, PathManager
from data.catalog import MetadataCatalog
from data.coco_data.coco_util import convert_to_coco_json
from data.evaluator import DatasetEvaluator
from models.head.structures import Boxes, BoxMode, pairwise_iou
from util.dist import gather, is_main_process, synchronize
from util.logger import create_small_table

try:
    from detectron2.evaluation.fast_eval_api import \
        COCOeval_opt  # TODO potentially add this
except ImportError:
