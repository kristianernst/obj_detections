...
from models.head.structures import ImageList, Instances
from models.layers import move_device_like
from models.postprocessing import detector_postprocess
from util.events import get_event_storage
from util.visualizer import convert_image_to_rgb
...
class GeneralizedRCNN(nn.Module):
  ...
  def preprocess_image(self, batched_inputs: List[Dict[str, torch.Tensor]]):
    ...
    images = ImageList.from_tensors(
      images,
      self.backbone._size_divisibility,
