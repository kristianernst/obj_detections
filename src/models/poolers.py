...
from models.head.structures import Boxes
from models.layers import (ROIAlign, ROIAlignRotated, cat, nonzero_tuple,
                           shapes_to_tensor)
from util.tracing import assert_fx_safe, is_fx_tracing
  ...
  def __init__(
    ...
    if pooler_type == "ROIAlign":
      self.level_poolers = nn.ModuleList(
        ROIAlign(output_size, spatial_scale=scale, sampling_ratio=sampling_ratio, aligned=False) for scale in scales
      )
