...
from data import transforms as asdads
from data.catalog import MetadataCatalog
from models.head.structures import (BitMasks, Boxes, BoxMode, Instances,
                                    Keypoints, PolygonMasks, RotatedBoxes,
                                    polygons_to_bitmask)
...
def transform_keypoint_annotations(keypoints, transforms, image_size, keypoint_hflip_indices=None):
  ...
  if do_hflip:
    ...
    if len(keypoints) != len(keypoint_hflip_indices):
      raise ValueError(
        "Keypoint data has {} points, but metadata " "contains {} points!".format(len(keypoints), len(keypoint_hflip_indices))
      )
